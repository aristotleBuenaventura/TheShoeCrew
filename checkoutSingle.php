...
if(isset($_POST['update_profile'])){
  ...
  if($update_query){
      ...
      header('location:checkoutSingle.php');
  }else{
    ...
    <div class="row gx-5">
      ...
      <form action="" method="post" class="update-profile-form " enctype="multipart/form-data">
          ...
          <div class="row mt-2 mb-3">
            <div class="col col-6 btn creditPay border rounded border-dark" onclick="openCredit()">
        ...
        <div class="row justify-content-center">
            ...
            <div class="row">
              <div class="col col-6">
                ...
                <div class=""><span class="fw-bold">Size: </span><?= $singleSize; ?></div>
                <div class="mb-4"><span class="fw-bold">Quantity:</span> (<?= $singleQuantity ; ?> piece/s.)</div>
              </div>
              <div class="col col-6">
                <div class="mb-4 text-end mt-5 fw-light">₱<?= number_format($singlePrice*$singleQuantity); ?>.00</div>
              </div>
            </div>
            ...
            <div class="row payment_area">
              ...
              <div class="col col-6 mt-4 mb-2">
                <h5 class="grand-total text-end fw-light">₱<?= number_format($singlePrice*$singleQuantity); ?>.00</h5>
                <h5 class="grand-total text-end fw-light">₱<?= number_format($_SESSION['shipping']); ?>.00</h5>
                <h5 class="grand-total text-end fw-light">₱<?= number_format((($singlePrice*$singleQuantity)*.12)); ?>.00</h5>
            ...
            <div class="row payment_area">
              ...
              <div class="col col-6 mt-3 mb-3">
                <h4 class="grand-total text-end ">₱<?= number_format((($singlePrice*$singleQuantity)*.12)+($singlePrice*$singleQuantity)+$_SESSION['shipping']); ?>.00</h4>
              </div>
            </div>
            <?php
                $_SESSION['grand_total'] = (($singlePrice*$singleQuantity)*.12)+($singlePrice*$singleQuantity)+$_SESSION['shipping'];
            ?>
    ...
    paypal.Buttons({
      ...
      onApprove: function(data, actions) {
        return actions.order.capture().then(function(orderData) {
          ...
          window.location.href = "successSingle.php?paypal_payment=true&id=" + id + "&price=" + price + "&quantity=" + quantity;
...
<script>
    function creditPayment(){
      window.location.href = "successSingle.php?credit_payment=true&id=" + id + "&price=" + price + "&quantity=" + quantity;
    }
  </script>  
